require("scripts.auto.auto_huodong_market_reward_card")
require("scripts.game.main.common.f_common_floating_notice")

--[[--
     功绩值兑换卡
--]]--
f_marketduihuan_card = class("f_marketduihuan_card")
f_marketduihuan_card.__index = f_marketduihuan_card

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] static_create
-- 静态创建方法，用于创建面板并返回实例
-------------------------------------------------------------------------------
function f_marketduihuan_card.static_create()
	local gongjizhiduihuan_card_table = createhuodong_market_reward_card()
	...
	setmetatable(funTable, f_marketduihuan_card)
...
-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] panelInitBeforePopup
-------------------------------------------------------------------------------
function f_marketduihuan_card:panelInitBeforePopup()
...
-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] registerNodeEvent
-------------------------------------------------------------------------------
function f_marketduihuan_card:registerNodeEvent(handler)
    if not handler then
...
-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] unregisterNodeEvent
-------------------------------------------------------------------------------
function f_marketduihuan_card:unregisterNodeEvent()
    self:unregisterScriptHandler()
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] onEnter
-------------------------------------------------------------------------------
function f_marketduihuan_card:onEnter()
	self:initAllComponent()
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] onExit
-------------------------------------------------------------------------------
function f_marketduihuan_card:onExit()  
...
-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] onEnterTransitionFinish
-------------------------------------------------------------------------------
function f_marketduihuan_card:onEnterTransitionFinish()
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] setCardDuihuanCallback
-- 设置兑换按钮点击的回调
-------------------------------------------------------------------------------
function f_marketduihuan_card:setCardDuihuanCallback(removeCallback)
	self.m_duihuan_button_callback = removeCallback
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] setCardRemoveFromListCallback
-- 设置物品卡数据从列表中移除的回调
-------------------------------------------------------------------------------
function f_marketduihuan_card:setCardRemoveFromListCallback(removeCallback)
	self.m_duihuan_remove_callback = removeCallback
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] onExitTransitionStart
-------------------------------------------------------------------------------
function f_marketduihuan_card:onExitTransitionStart()
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] onCleanup
-------------------------------------------------------------------------------
function f_marketduihuan_card:onCleanup()
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] setIndex
-- 设置在列表中的索引
-------------------------------------------------------------------------------
function f_marketduihuan_card:setIndex(index)
	self.m_index = index
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] getIndex
-- 获取在列表中的索引
-------------------------------------------------------------------------------
function f_marketduihuan_card:getIndex()
	return self.m_index
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] initAllComponent
-- 初始化所有面板中的组件
-------------------------------------------------------------------------------
function f_marketduihuan_card:initAllComponent()
	--点击兑换按钮
...
-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] duihuanClick
-------------------------------------------------------------------------------
function f_marketduihuan_card:duihuanClick()
...
-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] getData
-------------------------------------------------------------------------------
function f_marketduihuan_card:getData()
	return self.m_data
end

-------------------------------------------------------------------------------
-- @function [parent=#f_marketduihuan_card] setData
-------------------------------------------------------------------------------
function f_marketduihuan_card:setData2(type, id, des, price, num, hasBuy, coinText)
...
-- @function [parent=#f_marketduihuan_card] setData
-------------------------------------------------------------------------------
function f_marketduihuan_card:setData(data)
	self.m_data = data	
