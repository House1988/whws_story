--[[--
    ios 台湾 iap manager，用于ios app store购买
--]]--

local f_ios_taiwan_iap_manager = class("f_ios_taiwan_iap_manager")
f_ios_taiwan_iap_manager.__index = f_ios_taiwan_iap_manager

-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] ctor
-------------------------------------------------
function f_ios_taiwan_iap_manager:ctor()	
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] open
-- 开启购买模块
-------------------------------------------------
function f_ios_taiwan_iap_manager:open()	
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] loadProductsFromAppleServer
-- 使用产品key列表，从苹果服务器验证
-------------------------------------------------
function f_ios_taiwan_iap_manager:loadProductsFromAppleServer(itemList)	
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] getItemInfo
-- 使用productIdentifier从游戏内购数组中获取物品信息
-------------------------------------------------
function f_ios_taiwan_iap_manager:getItemInfo(productIdentifier)	
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] requestBuyResultFromGameServer
-- 发送购买收据到服务器进行验证
-------------------------------------------------
function f_ios_taiwan_iap_manager:requestBuyResultFromGameServer(transactionIdentifier, receipt, isNativePayment)
	local dataT = {}
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] checkNativePayment
-- 检查本地存储得收据凭证并进行继续验证
-------------------------------------------------
function f_ios_taiwan_iap_manager:checkNativePayment()	
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] iapStoreListener
-- 交易结果回调处理
-------------------------------------------------
function f_ios_taiwan_iap_manager:iapStoreListener(transaction)	
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] iapRequestProductsListener
-- 请求ios store数据回调处理
-------------------------------------------------
function f_ios_taiwan_iap_manager:iapRequestProductsListener(data)	
	self.m_products_array = {}	
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] getCustomTrascationIdForUser
-- 用于sdk事件统计
-------------------------------------------------
function f_ios_taiwan_iap_manager:getCustomTrascationIdForUser()
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] iapBuyItem
-- 请求ios 购买物品
-------------------------------------------------
function f_ios_taiwan_iap_manager:iapBuyItem(data)	
...
-------------------------------------------------
-- @function [parent=#f_ios_taiwan_iap_manager] responseBuyResultFromGameServer
-- 从游戏服务器接收购买物品结果
-------------------------------------------------
function f_ios_taiwan_iap_manager:responseBuyResultFromGameServer(msg)	
...
return f_ios_taiwan_iap_manager