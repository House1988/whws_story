function createzhanyi_10th_map()

    local table_zhanyi_10th_map = {}

    local zhanyi_10th_map = fc.FContainerPanel:create()
    zhanyi_10th_map:setSize(cc.size(960,640))
    table_zhanyi_10th_map["zhanyi_10th_map"] = zhanyi_10th_map

    local bglj_zy_ditubg_image = fc.FExtensionsImage:create()
    bglj_zy_ditubg_image:setImage("nobatch/jiawuzhongruzhanzheng.png")
    bglj_zy_ditubg_image:setSize(cc.size(701,443))
    bglj_zy_ditubg_image:setAnchorPoint(cc.p(0.5,0.5))
    zhanyi_10th_map:appendComponent(bglj_zy_ditubg_image)
    bglj_zy_ditubg_image:setPositionInContainer(cc.p(480.5,346.5))
    table_zhanyi_10th_map["bglj_zy_ditubg_image"] = bglj_zy_ditubg_image
    ...
    zhanyi_10th_map:appendComponent(small_battle_button_label5)
    small_battle_button_label5:setPositionInContainer(cc.p(330.5,501))
    table_zhanyi_10th_map["small_battle_button_label5"] = small_battle_button_label5
    ...
    zhanyi_10th_map:appendComponent(small_battle_button_label4)
    small_battle_button_label4:setPositionInContainer(cc.p(338.5,245))
    table_zhanyi_10th_map["small_battle_button_label4"] = small_battle_button_label4
    ...
    zhanyi_10th_map:appendComponent(small_battle_button_label3)
    small_battle_button_label3:setPositionInContainer(cc.p(698.5,249))
    table_zhanyi_10th_map["small_battle_button_label3"] = small_battle_button_label3
    ...
    zhanyi_10th_map:appendComponent(small_battle_button_label2)
    small_battle_button_label2:setPositionInContainer(cc.p(502.5,542))
    table_zhanyi_10th_map["small_battle_button_label2"] = small_battle_button_label2
    ...
    zhanyi_10th_map:appendComponent(small_battle_button_label1)
    small_battle_button_label1:setPositionInContainer(cc.p(741.5,432))
    table_zhanyi_10th_map["small_battle_button_label1"] = small_battle_button_label1
    ...
    zhanyi_10th_map:appendComponent(small_battle_button5)
    small_battle_button5:setPositionInContainer(cc.p(338,450.5))
    table_zhanyi_10th_map["small_battle_button5"] = small_battle_button5
    ...
    zhanyi_10th_map:appendComponent(small_battle_button4)
    small_battle_button4:setPositionInContainer(cc.p(338,300.5))
    table_zhanyi_10th_map["small_battle_button4"] = small_battle_button4
    ...
    zhanyi_10th_map:appendComponent(small_battle_button3)
    small_battle_button3:setPositionInContainer(cc.p(585.5,254))
    table_zhanyi_10th_map["small_battle_button3"] = small_battle_button3
    ...
    zhanyi_10th_map:appendComponent(small_battle_button2)
    small_battle_button2:setPositionInContainer(cc.p(502.5,504))
    table_zhanyi_10th_map["small_battle_button2"] = small_battle_button2
    ...
    zhanyi_10th_map:appendComponent(small_battle_button1)
    small_battle_button1:setPositionInContainer(cc.p(742.5,482))
    table_zhanyi_10th_map["small_battle_button1"] = small_battle_button1

    return table_zhanyi_10th_map
