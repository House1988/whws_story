function createjinluandian_nianhao()

    local table_jinluandian_nianhao = {}

    local jinluandian_nianhao = fc.FContainerPanel:create()
    jinluandian_nianhao:setSize(cc.size(520,262))
    table_jinluandian_nianhao["jinluandian_nianhao"] = jinluandian_nianhao
    ...
    jinluandian_nianhao:appendComponent(zhou_la)
    zhou_la:setPositionInContainer(cc.p(136,75.5))
    table_jinluandian_nianhao["zhou_la"] = zhou_la
    ...
    jinluandian_nianhao:appendComponent(zhou_lb)
    zhou_lb:setPositionInContainer(cc.p(136,186.5))
    table_jinluandian_nianhao["zhou_lb"] = zhou_lb
    ...
    jinluandian_nianhao:appendComponent(zhou_ra)
    zhou_ra:setPositionInContainer(cc.p(386,75.5))
    table_jinluandian_nianhao["zhou_ra"] = zhou_ra
    ...
    jinluandian_nianhao:appendComponent(zhou_rb)
    zhou_rb:setPositionInContainer(cc.p(386,186.5))
    table_jinluandian_nianhao["zhou_rb"] = zhou_rb
    ...
    jinluandian_nianhao:appendComponent(jld_nh_bian1_image)
    jld_nh_bian1_image:setPositionInContainer(cc.p(19.5,131))
    table_jinluandian_nianhao["jld_nh_bian1_image"] = jld_nh_bian1_image
    ...
    jinluandian_nianhao:appendComponent(jld_nh_bian2_image)
    jld_nh_bian2_image:setPositionInContainer(cc.p(500.5,131))
    table_jinluandian_nianhao["jld_nh_bian2_image"] = jld_nh_bian2_image
    ...
    jinluandian_nianhao:appendComponent(jld_nh_tishiyu_label)
    jld_nh_tishiyu_label:setPositionInContainer(cc.p(261,68))
    table_jinluandian_nianhao["jld_nh_tishiyu_label"] = jld_nh_tishiyu_label
    ...
    jinluandian_nianhao:appendComponent(jld_nh_input_image)
    jld_nh_input_image:setPositionInContainer(cc.p(263,128))
    table_jinluandian_nianhao["jld_nh_input_image"] = jld_nh_input_image
    ...
    jinluandian_nianhao:appendComponent(jld_nh_queding_button)
    ...
    jinluandian_nianhao:appendComponent(jld_nh_input)
    jld_nh_input:setPositionInContainer(cc.p(264,128))
    table_jinluandian_nianhao["jld_nh_input"] = jld_nh_input
    ...
    jinluandian_nianhao:appendComponent(suiji)
    suiji:setPositionInContainer(cc.p(428.5,117.5))
    table_jinluandian_nianhao["suiji"] = suiji

    return table_jinluandian_nianhao
