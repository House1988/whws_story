function createyihetuan_zhanyi()

    local table_yihetuan_zhanyi = {}

    local yihetuan_zhanyi = fc.FContainerPanel:create()
    yihetuan_zhanyi:setSize(cc.size(960,640))
    table_yihetuan_zhanyi["yihetuan_zhanyi"] = yihetuan_zhanyi

    local zf_zy_ditubg_image = fc.FExtensionsImage:create()
    zf_zy_ditubg_image:setImage("nobatch/yihetuan.png")
    zf_zy_ditubg_image:setSize(cc.size(701,443))
    zf_zy_ditubg_image:setAnchorPoint(cc.p(0.5,0.5))
    yihetuan_zhanyi:appendComponent(zf_zy_ditubg_image)
    zf_zy_ditubg_image:setPositionInContainer(cc.p(480.5,346.5))
    table_yihetuan_zhanyi["zf_zy_ditubg_image"] = zf_zy_ditubg_image
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button1)
    small_battle_button1:setPositionInContainer(cc.p(337,215.5))
    table_yihetuan_zhanyi["small_battle_button1"] = small_battle_button1
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button_label1)
    small_battle_button_label1:setPositionInContainer(cc.p(318.5,166))
    table_yihetuan_zhanyi["small_battle_button_label1"] = small_battle_button_label1
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button2)
    small_battle_button2:setPositionInContainer(cc.p(452,271.5))
    table_yihetuan_zhanyi["small_battle_button2"] = small_battle_button2
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button_label2)
    small_battle_button_label2:setPositionInContainer(cc.p(452.5,318))
    table_yihetuan_zhanyi["small_battle_button_label2"] = small_battle_button_label2
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button3)
    small_battle_button3:setPositionInContainer(cc.p(562,213.5))
    table_yihetuan_zhanyi["small_battle_button3"] = small_battle_button3
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button_label3)
    small_battle_button_label3:setPositionInContainer(cc.p(572.5,164))
    table_yihetuan_zhanyi["small_battle_button_label3"] = small_battle_button_label3
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button_label4)
    small_battle_button_label4:setPositionInContainer(cc.p(407.5,467))
    table_yihetuan_zhanyi["small_battle_button_label4"] = small_battle_button_label4
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button4)
    small_battle_button4:setPositionInContainer(cc.p(427,411.5))
    table_yihetuan_zhanyi["small_battle_button4"] = small_battle_button4
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button5)
    small_battle_button5:setPositionInContainer(cc.p(630,411.5))
    table_yihetuan_zhanyi["small_battle_button5"] = small_battle_button5
    ...
    yihetuan_zhanyi:appendComponent(small_battle_button_label5)
    small_battle_button_label5:setPositionInContainer(cc.p(639.5,467))
    table_yihetuan_zhanyi["small_battle_button_label5"] = small_battle_button_label5

    return table_yihetuan_zhanyi
