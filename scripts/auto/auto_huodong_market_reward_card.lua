function createhuodong_market_reward_card()

    local table_qgyd_gjzdh_card = {}

    local qgyd_gjzdh_card = fc.FContainerPanel:create()
    qgyd_gjzdh_card:setSize(cc.size(226,380))
    ...
    gjzdh_bg_scale9:setSize(cc.size(206,340))
    gjzdh_bg_scale9:setAnchorPoint(cc.p(0.5,0.5))
    qgyd_gjzdh_card:appendComponent(gjzdh_bg_scale9)
    gjzdh_bg_scale9:setPositionInContainer(cc.p(113,190))
    ...
    gjzdh_gongjizhi_label:setPositionInContainer(cc.p(114,283))
    ...
    gjzdh_shuoming_label:setPositionInContainer(cc.p(113,203))
    ...
    bottom_bar:setPositionInContainer(cc.p(113,370.5))
    ...
    shutiao:setSize(cc.size(25,339))
    shutiao:setAnchorPoint(cc.p(0.5,0.5))
    qgyd_gjzdh_card:appendComponent(shutiao)
    shutiao:setPositionInContainer(cc.p(213.5,210))
    ...
    shutiao:setAnchorPoint(cc.p(0.5,0.5))
    qgyd_gjzdh_card:appendComponent(shutiao)
    shutiao:setPositionInContainer(cc.p(12.5,210))
    table_qgyd_gjzdh_card["shutiao"] = shutiao
    ...
    textbg:setPositionInContainer(cc.p(114,256))
    ...
    gjzdh_gongjizhi_num_label:setPositionInContainer(cc.p(114,252))
    ...
    duihuan:setPositionInContainer(cc.p(113,350))
    ...
    gjzdh_duihuan_button:setPositionInContainer(cc.p(113,323.5))
