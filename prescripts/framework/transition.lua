...
function transition.runAnimationOnce(target, animation, removeWhenFinished, onComplete, delay)
    local actions = {}
...
function transition.runAnimationForever(target, animation, delay)
