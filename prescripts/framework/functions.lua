...
-------------------------------------------------------------------------------
-- @function [parent=#string] hybridTextLen
-- 获取utf8混合字符串的长度，英文字符算半个，中文字符算一个
-------------------------------------------------------------------------------
function string.hybridTextLen(str)
    local len  = #str
    local left = len
    local cnt  = 0
    local arr  = {0, 0xc0, 0xe0, 0xf0, 0xf8, 0xfc}
...
-------------------------------------------------------------------------------
-- @function [parent=#string] getHybridChar
-- 获取utf8混合字符串中指定索引的字符
-------------------------------------------------------------------------------
function string.getHybridChar(str, index)
	local utflen = string.utf8len(str)
    local len  = #str    
    local left = len
    local cnt  = 0
    local arr  = {0, 0xc0, 0xe0, 0xf0, 0xf8, 0xfc}
