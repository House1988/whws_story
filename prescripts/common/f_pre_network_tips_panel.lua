...
local f_pre_network_tips_panel = class("f_pre_network_tips_panel", function()
    return fc.FContainerPanel:create()
end)


-------------------------------------------------------------------------------
-- @function [parent=#f_pre_network_tips_panel] ctor
-- 构造函数
-------------------------------------------------------------------------------
function f_pre_network_tips_panel:ctor()
...
-------------------------------------------------------------------------------
-- @function [parent=#f_pre_network_tips_panel] onEnter
-- on, 初始化事件监听
-------------------------------------------------------------------------------
function f_pre_network_tips_panel:onEnter()    
end


function f_pre_network_tips_panel:onExit()    
    self:unregisterNodeEvent()
end

function f_pre_network_tips_panel:onEnterTransitionFinish()
end

function f_pre_network_tips_panel:onExitTransitionStart()
end

function f_pre_network_tips_panel:onCleanup()
end


function f_pre_network_tips_panel:registerNodeEvent(handler)
    if not handler then
...
-------------------------------------------------------------------------------
-- @function [parent=#f_pre_network_tips_panel] unregisterNodeEvent
-------------------------------------------------------------------------------
function f_pre_network_tips_panel:unregisterNodeEvent()
    self:unregisterScriptHandler()
end


function f_pre_network_tips_panel:createLayoutPanel()
...
-------------------------------------------------------------------------------
-- @function [parent=#f_pre_network_tips_panel] createCommonTips
-- 创建一般提示窗体，只有确定按钮
-------------------------------------------------------------------------------
function f_pre_network_tips_panel:createCommonTips()	
...
-------------------------------------------------------------------------------
-- @function [parent=#f_pre_network_tips_panel] setShowText
--设置显示面板中文本
-------------------------------------------------------------------------------
function f_pre_network_tips_panel:setShowText(text)
	self.m_show_text = text
end


-------------------------------------------------------------------------------
-- @function [parent=#f_pre_network_tips_panel] addCallback
--添加按钮回调函数，自左向右顺序添加
-------------------------------------------------------------------------------
function f_pre_network_tips_panel:addCallback(callback)
...
-------------------------------------------------------------------------------
-- @function [parent=#f_pre_network_tips_panel] hide
--隐藏面板
-------------------------------------------------------------------------------
function f_pre_network_tips_panel:hide()
	local layer = g_resource.g_director:getRunningScene():get_layer_from_config(4)
	layer:removeChild(self.m_autoPanel, true)
end

return f_pre_network_tips_panel